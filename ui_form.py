...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.loadFile.setGeometry(QRect(10, 10, 91, 31))
        ...
        self.plainTextEdit.setGeometry(QRect(10, 50, 581, 431))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Fundamental Save Editor", None))
        self.loadFile.setText(QCoreApplication.translate("MainWindow", u"Load File", None))
        self.saveFile.setText(QCoreApplication.translate("MainWindow", u"Save File", None))
    # retranslateUi
